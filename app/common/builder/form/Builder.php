...
class Builder extends ZBuilder
{
    ...
    {
        $templatePath = Env::get('app_path') . 'admin/builder/form/layout.html';
        $this->_template = file_exists($templatePath) ? $templatePath : Env::get('app_path') . 'common/builder/form/layout.html';
